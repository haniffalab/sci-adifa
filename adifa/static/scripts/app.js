  ...
  $(document).ready(function () {
    ...
    if ($("#canvas-container").length) {
      ...
      $("#genes").on("update", function (event) {
        if (
          ...
          this.selectedItems[0] !== $("#color-scale-value").text() &&
          scatterplot
        ) {
          colorize(this);
        }
      ...
      $(document.body).on("click", ".btn-gene-select", function (event) {
        ...
        if ($(target).hasClass("btn-disease-gene")) {
          ...
          if (
            !$("#search-genes-selected #gene-deg-" + escapeSelector(gene))
              .length
          ) {
    ...
    if ($("#matrixplot-container").length) {
      ...
      $(document.body).on("click", ".btn-gene-select", function (event) {
        ...
        if ($(this).text() !== $("#color-scale-value").text() && matrixplot)
          matrixplot.genes(this);
      });
    }
  });
})(jQuery);
